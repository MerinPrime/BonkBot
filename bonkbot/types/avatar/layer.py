...
class Layer:
    ...
    scale: float = field(default=0.25, converter=float, validator=validate_float(-10, 10))
    angle: float = field(default=0, converter=float, validator=validate_float(-9999, 9999))
    x: float = field(default=0, converter=float, validator=validate_float(-99999, 99999))
    y: float = field(default=0, converter=float, validator=validate_float(-99999, 99999))
